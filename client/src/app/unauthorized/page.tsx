  ...
  return (
    <div className="h-screen bg-linear-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-4 -right-4 h-72 w-72 rounded-full bg-linear-to-br from-blue-400/20 to-purple-400/20 blur-3xl"></div>
        <div className="absolute top-1/3 -left-8 h-96 w-96 rounded-full bg-linear-to-br from-purple-400/15 to-pink-400/15 blur-3xl"></div>
        <div className="absolute right-1/3 bottom-1/4 h-64 w-64 rounded-full bg-linear-to-br from-blue-400/10 to-cyan-400/10 blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 flex h-full min-h-screen w-full flex-col items-center justify-center gap-2">
        ...
        <p className="text-muted-foreground mb-8 max-w-md px-4 text-center text-base md:text-lg">
          Please log in with the appropriate credentials <br className="hidden md:block" />
