    ...
    <section className="from-primary/10 via-primary/5 to-background relative overflow-hidden bg-linear-to-br py-12 md:py-16">
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="mb-6 text-3xl font-bold md:text-4xl lg:text-5xl">Sẵn sàng khám phá?</h2>
          <p className="text-muted-foreground mb-8 text-lg md:text-xl">
            Trải nghiệm nền tảng LMS hiện đại với đầy đủ tính năng production-ready.
            <br />
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Button size="lg" className="gap-2 px-8" asChild>
              <a href="https://learnhub.vercel.app" target="_blank" rel="noopener noreferrer">
                Xem Demo V2
                <ArrowRight className="h-4 w-4" />
              </a>
            </Button>
            <Button size="lg" variant="outline" className="gap-2 px-8" asChild>
              <a href="https://github.com/tinphancr7" target="_blank" rel="noopener noreferrer">
          ...
          <div className="bg-card mt-12 rounded-xl border p-6 shadow-lg">
            ...
            <p className="text-muted-foreground text-sm">
              Nếu bạn thấy dự án này hữu ích, đừng quên để lại một comment, like và ⭐ star trên
              GitHub để ủng hộ mình nhé! Cảm ơn các bạn rất nhiều!
            </p>
          </div>
