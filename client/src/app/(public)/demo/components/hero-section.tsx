...
function HeroSection() {
  return (
    <section className="from-primary/5 via-background to-background relative overflow-hidden bg-gradient-to-b pt-16 pb-16 md:pt-20 md:pb-20">
      {/* Animated background */}
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-10 grid grid-cols-2 gap-4 md:grid-cols-4">
            <div className="bg-card rounded-lg border p-4">
              ...
              <div className="text-muted-foreground text-sm">Phiên bản</div>
            </div>
            <div className="bg-card rounded-lg border p-4">
              <div className="text-primary text-3xl font-bold">50+</div>
              <div className="text-muted-foreground text-sm">Tính năng</div>
            </div>
            <div className="bg-card rounded-lg border p-4">
              <div className="text-primary text-3xl font-bold">10+</div>
              <div className="text-muted-foreground text-sm">Công nghệ</div>
            </div>
            <div className="bg-card rounded-lg border p-4">
