 ...
 *
 */
export type UserMemoryModel =
  runtime.Types.Result.DefaultSelection<Prisma.$UserMemoryPayload>;
...
> = {
  where?: Prisma.UserMemoryWhereInput;
  orderBy?:
    | Prisma.UserMemoryOrderByWithAggregationInput
    | Prisma.UserMemoryOrderByWithAggregationInput[];
...
type GetUserMemoryGroupByPayload<T extends UserMemoryGroupByArgs> =
...
export type UserMemoryWhereInput = {
  ...
  summary?: Prisma.StringFilter<'UserMemory'> | string;
  traits?: Prisma.JsonNullableFilter<'UserMemory'>;
...
export type UserMemoryScalarWhereWithAggregatesInput = {
  ...
  summary?: Prisma.StringWithAggregatesFilter<'UserMemory'> | string;
  traits?: Prisma.JsonNullableWithAggregatesFilter<'UserMemory'>;
...
export type UserMemoryUpdateOneWithoutUserNestedInput = {
  ...
  update?: Prisma.XOR<
    Prisma.XOR<
      Prisma.UserMemoryUpdateToOneWithWhereWithoutUserInput,
...
> = runtime.Types.Extensions.GetOmit<
  'id' | 'userId' | 'summary' | 'traits' | 'updatedAt',
  ExtArgs['result']['userMemory']
>;
...
export type UserMemoryGetPayload<
  S extends boolean | null | undefined | UserMemoryDefaultArgs,
...
> {
  ...
  >(
    args: Prisma.SubsetIntersection<T, UserMemoryGroupByArgs, OrderByArg> &
      InputErrors,
  ): {} extends InputErrors
    ? GetUserMemoryGroupByPayload<T>
...
export interface UserMemoryFieldRefs {
  ...
  readonly summary: Prisma.FieldRef<'UserMemory', 'String'>;
  readonly traits: Prisma.FieldRef<'UserMemory', 'Json'>;
...
> = {
   ...
   */
  distinct?:
    | Prisma.UserMemoryScalarFieldEnum
    | Prisma.UserMemoryScalarFieldEnum[];
};
